(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var StepperViewBase = /** @class */ (function () {
        function StepperViewBase(steps) {
            this.steps = steps;
        }
        StepperViewBase.prototype.getStepsCount = function () {
            return this.steps.length;
        };
        StepperViewBase.prototype.getCurrentStepIndex = function () {
            return this.currentStepIndex;
        };
        StepperViewBase.prototype.getSteps = function () {
            return this.steps;
        };
        StepperViewBase.prototype.setStep = function (index) {
        ...
        StepperViewBase.prototype.isStepValid = function (index) {
            /**
        ...
        return StepperViewBase;
    }());

    var StepperView = /** @class */ (function (_super) {
        __extends(StepperView, _super);
        function StepperView(steps) {
            var _this = _super.call(this, steps) || this;
            _this.setup(_this.getSteps());
            return _this;
        }
        StepperView.prototype.setStepActive = function (index) {
            var _a = this.setStep(index), prev = _a[0], next = _a[1];
            if (prev)
                prev.classList.remove(StepperClassNames$1.itemActive);
            if (next)
                next.classList.add(StepperClassNames$1.itemActive);
            if (this.progress) {
                this.progress.setActive(index);
            }
        };
        StepperView.prototype.enableProgress = function (progress) {
    ...
    var ProgressView = /** @class */ (function () {
        function ProgressView(stepsCount, container) {
    ...
    var Stepper = /** @class */ (function () {
        ...
        Stepper.prototype.stepTo = function (step, cb) {
            var ok = this.performStepChange(step, cb);
            if (!ok) {
        ...
        Stepper.prototype.setup = function (container, opts) {
            ...
            if (opts.progress) {
                this.stepperView.enableProgress(new ProgressView(this.stepperView.getStepsCount(), opts.progressContainer));
            }
        };
        ...
        Stepper.prototype.performStepChange = function (next, cb) {
            var prev = this.stepperView.getCurrentStepIndex();
            next = Number.parseInt(next);
            if (this.frozen) {
                console.warn('[Stepper.js] is frozen');
                return;
            }
            var ok = this.isStepChangeValid(prev, next);
            if (!ok)
                return;
