    ...
    ***************************************************************************** */
    ...
    var Stepper$1 = /** @class */ (function () {
        function Stepper(container, opts) {
            ...
            this.stepperView = new StepperView(container, this.composeStepperViewOpts(this.options, this.state));
        ...
        Stepper.prototype.getInitialState = function () {
            if (this.options.cache) {
                try {
                    var state = JSON.parse(localStorage.getItem(this.cacheId));
        ...
        Stepper.prototype.composeStepperViewOpts = function (opts, state) {
            var _this = this;
            var index = state.step ? state.step.index : opts.startStep;
            return {
                index: index,
