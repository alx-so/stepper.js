(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var StepperViewBase = /** @class */ (function () {
        ...
        StepperViewBase.prototype.getStepsHtml = function () {
            return this.steps;
        };
        StepperViewBase.prototype.getCurrentStep = function () {
            return this.currentStep;
        };
        StepperViewBase.prototype.getStep = function (index) {
    ...
    var Stepper = /** @class */ (function () {
        ...
        Stepper.prototype.stepTo = function (stepIndex, cb) {
            var ok = this.performStepChange(stepIndex, cb);
            if (!ok) {
